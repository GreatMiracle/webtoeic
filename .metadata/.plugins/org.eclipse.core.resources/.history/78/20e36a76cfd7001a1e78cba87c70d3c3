...
<head>
<meta charset="UTF-8">
<title>Quản lí danh sách bài đọc</title>
			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li><a href="#">Quản lý bài tập đọc</a></li>
						<li class="active">Thêm danh sách bài đọc</li>
								...
								<div class="col-xs-12">
									<table id="simple-table"
										...
										<tbody>
											...
											<c:forEach items="${lsAllExReading}" var="list">
												<tr>
													<td class="center">${list.readexeriseid}</td>
													<td class="center">${list.readname}</td>
<%-- 													<td class="center">${list.readimage}</td> --%>
													<td class="center">
														<img src="Imageandfilebtdoc/${list.readimage}" class="media-object" alt=''  width="64px" height="40px"/>
													</td>
									...
									<div>
										<ul class="pagination">
											<c:if test="${numberpage == 1}">
												...
												<li  class="active"><a href="Hienthidsbtdoc?pageid=${numberpage}">${numberpage}</a></li>
												<c:if test="${numberpage == 1 && numberpage < maxpageid}">
													<li><a href="Hienthidsbtdoc?pageid=${numberpage+1}">${numberpage+1}</a></li>
											...
											<c:if test="${numberpage > 1 && numberpage < maxpageid}">
												<li><a href="Hienthidsbtdoc?pageid=${numberpage-1}">Prev</a></li>
												<li><a href="Hienthidsbtdoc?pageid=${numberpage-1}">${numberpage-1}</a></li>
												<li class="active"><a class="active" href="Hienthidsbtdoc?pageid=${numberpage}">${numberpage}</a></li>
												<li><a href="Hienthidsbtdoc?pageid=${numberpage+1}">${numberpage+1}</a></li>
												<li><a href="Hienthidsbtdoc?pageid=${numberpage+1}">Next</a></li>
											</c:if>
										</ul>
							...
							<div class="row">
								<div class="col-xs-12">
									<button type="button"
										...
										data-target="#myModal">Thêm bài tập đọc</button>
			...
			<form action="Themtenbtdoc" method="POST">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Thêm tên bài đọc</h4>
					</div>
					...
					<div class="modal-footer">
						<button class="btn btn-info" type="submit">
							<i class="ace-icon fa fa-check bigger-110"></i> Thêm tên bài đọc
						</button>
					</div>
				</div>
			</form>
