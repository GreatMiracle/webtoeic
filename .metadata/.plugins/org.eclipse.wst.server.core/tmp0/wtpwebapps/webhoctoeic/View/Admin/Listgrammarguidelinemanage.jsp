...
<head>
<meta charset="UTF-8">
<title>Hiển thị danh sách quản lí ngữ pháp</title>
...
<%-- 													<td class="center">${list.grammarimage}</td> --%>
													<td class="center">
													<img src="Imageupload/${list.grammarimage}"
						class="media-object" alt=''  width="64px" height="40px"/></a>
													</td>
													<td class="center"><a class="red"
														href="Xoabaihdnguphap?grammarguidelineid=${list.grammarguidelineid}">
									...
									<div>
										<ul class="pagination">
											<c:if test="${numberpage == 1}">
												...
												<li  class="active"><a href="Listgrammarguidelinemanage?pageid=${numberpage}">${numberpage}</a></li>
												<c:if test="${numberpage == 1 && numberpage < maxpageid}">
													<li><a href="Listgrammarguidelinemanage?pageid=${numberpage+1}">${numberpage+1}</a></li>
											...
											<c:if test="${numberpage > 1 && numberpage < maxpageid}">
												<li><a href="Listgrammarguidelinemanage?pageid=${numberpage-1}">Prev</a></li>
												<li><a href="Listgrammarguidelinemanage?pageid=${numberpage-1}">${numberpage-1}</a></li>
												<li class="active"><a class="active" href="Listgrammarguidelinemanage?pageid=${numberpage}">${numberpage}</a></li>
												<li><a href="Listgrammarguidelinemanage?pageid=${numberpage+1}">${numberpage+1}</a></li>
												<li><a href="Listgrammarguidelinemanage?pageid=${numberpage+1}">Next</a></li>
											</c:if>
										</ul>
