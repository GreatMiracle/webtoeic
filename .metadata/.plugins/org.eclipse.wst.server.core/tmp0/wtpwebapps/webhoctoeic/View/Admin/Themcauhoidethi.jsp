								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter bigger">
											<i class="ace-icon fa fa-coffee green"></i> Thêm câu hỏi cho đề thi
										</h4>

										<div class="space-6"></div>

										<form
											action="Themcauhoidethi?examinationid=<%=request.getAttribute("examinationid")%>"
												...
												<div class="clearfix">
													...
													<button type="submit"
														...
														<i class="ace-icon fa fa-key"></i> <span
															class="bigger-110">Thêm câu hỏi đề thi</span>
													</button>
												</div>
