...
<body class="no-skin">
		...
		<!--[if !IE]> -->
		<script type="text/javascript">
			window.jQuery || document.write("<script src='Template/Backend/assets/js/jquery.min.js'>"+"<"+"/script>");
		</script>
		...
		<script src="Template/Backend/assets/js/jquery.sparkline.min.js"></script>
		<script src="Template/Backend/assets/js/jquery.flot.min.js"></script>
		<script src="Template/Backend/assets/js/jquery.flot.pie.min.js"></script>
		<script src="Template/Backend/assets/js/jquery.flot.resize.min.js"></script>
