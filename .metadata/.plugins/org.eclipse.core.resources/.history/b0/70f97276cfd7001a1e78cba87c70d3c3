...
<!-- 							</p> -->
			...
			<!-- /. PAGE TITLE-->
			<div class="row">
				<c:forEach var="list" items="${lsAllExListening}">
					<div class="span6">
						<div class="media">
							<a href="#" class="pull-left"><img
								src="Filebtphannghe/${list.listenexerciseimage}" class="media-object"
								alt='' width="128px" height="128px" /></a>
							<div class="media-body">

								<p>${list.listenexercisename}</p>
								<a
									href="Lambainghe?pageid=1&listenexerciseid=${list.listenexerciseid}"
									class="btn">Làm bài nghe</a>
							</div>
						</div>
					</div>
				</c:forEach>
			...
			<div class="pagination">
				<ul>
					<c:if test="${numberpage == 1}">
						...
						<li><a href="Hienthidsbtnghe?pageid=${numberpage}">${numberpage}</a></li>
						<li><a href="Hienthidsbtnghe?pageid=${numberpage+1}">${numberpage+1}</a></li>
						<li><a href="Hienthidsbtnghe?pageid=${numberpage+1}">Next
								&raquo;</a></li>
					</c:if>
					<c:if test="${numberpage == maxpageid}">
						<li><a href="Hienthidsbtnghe?pageid=${numberpage-1}">&laquo;Prev</a></li>
						<li><a href="Hienthidsbtnghe?pageid=${numberpage-1}">${numberpage-1}</a></li>
						<li><a href="Hienthidsbtnghe?pageid=${numberpage}">${numberpage}</a></li>
