...
<head>
<meta charset="UTF-8">
<title>Danh sách các câu hỏi nghe trong bài</title>
			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Danh sách câu hỏi nghe trong bài</li>
				...
				<div class="page-content">
					<c:if test="${msgDetailListening!=null}">
						<h4 class="pink">
							<i
								class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i>

							<a class="green" data-toggle="modal">${msgDetailListening}</a>
						</h4>
									...
									<table id="simple-table"
										...
										<thead>
											<tr>
												...
												<th class="center">Bài nghe</th>
												<th class="center">Đáp án đúng</th>
										...
										<tbody>
											...
											<c:forEach items="${detailListening}" var="list">
												<tr>
													<td class="center">${list.num}</td>
													<td class="center">${list.question}</td>


													<td class="center"><img
														src="Filebtphannghe/${list.imagename}"
														class="media-object" alt='' width="64px" height="40px" />
													</td>
													<td class="center"><audio controls>
													...
													<td class="center">${list.correctanswer}</td>
									...
									<div>
										<ul class="pagination">
											<c:if test="${numberpage == 1}">
												...
												<li class="active"><a
													href="DetailListening?pageid=${numberpage}&listenexerciseid=${listenexerciseid}">${numberpage}</a></li>
												<c:if test="${numberpage == 1 && numberpage < maxpageid}">
													<li><a
														href="DetailListening?pageid=${numberpage+1}&listenexerciseid=${listenexerciseid}">${numberpage+1}</a></li>
													<li><a
														href="DetailListening?pageid=${numberpage+1}&listenexerciseid=${listenexerciseid}">Next</a></li>
												</c:if>
												<c:if test="${numberpage == 1 && numberpage == maxpageid}">
											...
											<c:if test="${numberpage > 1 && numberpage == maxpageid}">
												<li><a
													href="DetailListening?pageid=${numberpage-1}&listenexerciseid=${listenexerciseid}">Prev</a></li>
												<li><a
													href="DetailListening?pageid=${numberpage-1}&listenexerciseid=${listenexerciseid}">${numberpage-1}</a></li>
												<li class="active"><a
													href="DetailListening?pageid=${numberpage}&listenexerciseid=${listenexerciseid}">${numberpage}</a></li>
											...
											<c:if test="${numberpage > 1 && numberpage < maxpageid}">
												...
												<li><a
													href="DetailListening?pageid=${numberpage+1}&listenexerciseid=${listenexerciseid}">${numberpage+1}</a></li>
												<li><a
													href="DetailVocabTitle?pageid=${numberpage+1}&listenexerciseid=${listenexerciseid}">Next</a></li>
											</c:if>
										</ul>
									</div>
								</div>
...
<!-- 										data-target="#myModal">Thêm chủ đề từ vựng</button> -->

<!-- 									<a href="Themaudiohinhanhtuvung" role="button" -->
<!-- 										class="btn btn-white btn-warning btn-bold">Thêm audio và -->
<!-- 										hình ảnh cho chủ đề từ vựng</a> -->
				...
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button class="btn btn-info" type="submit">
							<i class="ace-icon fa fa-check bigger-110"></i> Thêm chủ đề từ
							vựng
						</button>
					</div>
				</div>
