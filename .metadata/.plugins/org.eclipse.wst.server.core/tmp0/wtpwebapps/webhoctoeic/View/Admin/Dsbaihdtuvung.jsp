...
<head>
<meta charset="UTF-8">
<title>Hiển thị danh sách quản lí từ vựng</title>
			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Thêm danh sách bài hướng dẫn từ vựng</li>
									...
									<table id="simple-table"
										...
										<thead>
											<tr>
												...
												<th class="center">Hình chủ đề</th>
...
<%-- 													<td class="center">${list.vocabularyname}</td> --%>
													<td class="center">
														<a class="green" href="DetailVocabTitle?pageid=1&vocabularyguidelineid=${list.vocabularyguidelineid}">
													${list.vocabularyname}</a></td>
<%-- 													<td class="center">${list.grammarimage}</td> --%>
													<td class="center">
													<img src="Imageaudiohdtuvung/${list.vocabularyimage}"
						class="media-object" alt=''  width="64px" height="40px"/></a>
													</td>
													...
													<td class="center"><a class="green"
														href="Themndchudetuvung?vocabularyguidelineid=${list.vocabularyguidelineid}">
									...
									<div>
										<ul class="pagination">
											<c:if test="${numberpage == 1}">
												...
												<li  class="active"><a href="Hienthidsquanlytuvung?pageid=${numberpage}">${numberpage}</a></li>
												<c:if test="${numberpage == 1 && numberpage < maxpageid}">
													<li><a href="Hienthidsquanlytuvung?pageid=${numberpage+1}">${numberpage+1}</a></li>
													<li><a href="Hienthidsquanlytuvung?pageid=${numberpage+1}">Next</a></li>
												</c:if>
												<c:if test="${numberpage == 1 && numberpage == maxpageid}">
											...
											<c:if test="${numberpage > 1 && numberpage == maxpageid}">
												<li><a href="Hienthidsquanlytuvung?pageid=${numberpage-1}">Prev</a></li>
												<li><a href="Hienthidsquanlytuvung?pageid=${numberpage-1}">${numberpage-1}</a></li>
												<li  class="active"><a href="Hienthidsquanlytuvung?pageid=${numberpage}">${numberpage}</a></li>
											...
											<c:if test="${numberpage > 1 && numberpage < maxpageid}">
												<li><a href="Hienthidsquanlytuvung?pageid=${numberpage-1}">Prev</a></li>
												<li><a href="Hienthidsquanlytuvung?pageid=${numberpage-1}">${numberpage-1}</a></li>
												<li class="active"><a class="active" href="Hienthidsquanlytuvung?pageid=${numberpage}">${numberpage}</a></li>
												<li><a href="Hienthidsquanlytuvung?pageid=${numberpage+1}">${numberpage+1}</a></li>
												<li><a href="Hienthidsquanlytuvung?pageid=${numberpage+1}">Next</a></li>
											</c:if>
										</ul>
