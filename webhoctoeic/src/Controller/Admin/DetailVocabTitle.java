...
@WebServlet("/DetailVocabTitle")
public class DetailVocabTitle extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public DetailVocabTitle() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("View/Admin/DetailVocabTitle.jsp");
