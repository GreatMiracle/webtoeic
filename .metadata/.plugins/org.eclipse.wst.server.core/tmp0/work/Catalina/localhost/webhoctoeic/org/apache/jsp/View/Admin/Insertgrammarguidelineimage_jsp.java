 ...
 * Generated at: 2020-08-06 13:27:56 UTC
...
public final class Insertgrammarguidelineimage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<i class=\"ace-icon fa fa-coffee green\"></i> Thêm ảnh cho bài\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\thướng dẫn ngữ pháp\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</h4>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"space-6\"></div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<form\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\taction=\"Uploadgrammarguidelineimage?grammarguidelineid=");
      out.print(request.getAttribute("grammarguidelineid"));
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tmethod=\"POST\" enctype=\"multipart/form-data\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<fieldset>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<label class=\"block clearfix\"> ");
      out.print(request.getAttribute("msgrammarguidelineimage") != null
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"bigger-110\">Thêm ảnh bài hướng dẫn</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
