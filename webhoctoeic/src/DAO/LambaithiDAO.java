...
public class LambaithiDAO {
	...
	public static String NameTest(Connection conn, int examinationid) {
		String name = "";

		String sql = "select examinationame from examination where examinationid=" + examinationid;
		...
		try {
			...
			name = rs.getString("examinationame");
	...
	public static String Dapancua1cauhoi(Connection conn, int examinationid, int num) {
		...
		String sql = "select correctanswer from examinationquestion where examinationid=" + examinationid + " and num="
				+ num;
	...
	public static List<Result> Xuatketquathi(Connection conn, String time, int examinationid, int memberid) {
		...
		String sql = "select * from result where time='" + time + "' and examinationid=" + examinationid
