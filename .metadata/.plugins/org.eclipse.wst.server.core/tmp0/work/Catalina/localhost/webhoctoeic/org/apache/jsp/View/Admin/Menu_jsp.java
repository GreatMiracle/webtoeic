...
public final class Menu_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t<span class=\"menu-text\">Quản lý phần HD</span>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<li class=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"Listgrammarguidelinemanage?pageid=1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"menu-icon fa fa-caret-right\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\tNgữ pháp\r\n");
      out.write("\t\t\t\t\t\t\t\t</a>\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t<a href=\"Grammarguidelinemanage\"> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t\t<i class=\"menu-icon fa fa-caret-right\"></i> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t\tNgữ pháp -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t</a> -->\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<li class=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"Hienthidsquanlytuvung?pageid=1\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"menu-icon fa fa-caret-right\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\tTừ vựng\r\n");
      out.write("\t\t\t\t\t\t\t\t</a>\r\n");
      ...
      out.write("\t\t\t\t\t\t<a href=\"#\" class=\"dropdown-toggle\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"menu-icon fa fa-list\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"menu-text\">Quản lý phần bài tập</span>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<b class=\"arrow fa fa-angle-down\"></b>\r\n");
      out.write("\t\t\t\t\t\t</a>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t<ul class=\"submenu\">\r\n");
      out.write("\t\t\t\t\t\t\t<li class=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"Hienthidsbtdoc?pageid=1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"menu-icon fa fa-caret-right\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\tBài tập đọc\r\n");
      out.write("\t\t\t\t\t\t\t\t</a>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<b class=\"arrow\"></b>\r\n");
      out.write("\t\t\t\t\t\t\t</li>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<li class=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"Hienthidsquanlybtnghe?pageid=1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"menu-icon fa fa-caret-right\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\tBài tập nghe\r\n");
      out.write("\t\t\t\t\t\t\t\t</a>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<b class=\"arrow\"></b>\r\n");
      out.write("\t\t\t\t\t\t\t</li>\r\n");
      ...
      out.write("\t\t\t\t\t\t<a href=\"#\" class=\"dropdown-toggle\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"menu-icon fa fa-list\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"menu-text\">Quản lý đề thi</span>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<b class=\"arrow fa fa-angle-down\"></b>\r\n");
      out.write("\t\t\t\t\t\t</a>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t<ul class=\"submenu\">\r\n");
      out.write("\t\t\t\t\t\t\t<li class=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"Hienthidsquanlydethi?pageid=1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"menu-icon fa fa-caret-right\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\tĐề thi\r\n");
      out.write("\t\t\t\t\t\t\t\t</a>\r\n");
      out.write("\r\n");
