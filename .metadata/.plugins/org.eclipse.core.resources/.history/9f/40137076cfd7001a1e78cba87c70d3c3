								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter bigger">
											<i class="ace-icon fa fa-coffee green"></i> Thêm nọi dung chủ đề từ vựng
										</h4>

										<div class="space-6"></div>

										<form
											action="Themndchudetuvung?vocabularyguidelineid=${vocabularyguidelineid}"
<%-- 											action="Themndchudetuvung?vocabularyguidelineid=<c:out value="${vocabularyguidelineid}"/>" --%>
											method="POST" enctype="multipart/form-data">
											<fieldset>
												<label class="block clearfix"> 
												<c:if test="${msgUpLoadVocabContent != null}">
													${msgUpLoadVocabContent}
												</c:if>
								
												</label> 
												<label class="block clearfix"> Thêm file: <input
													type="file" name="file"
												...
												<div class="clearfix">
													...
													<button type="submit"
														...
														<i class="ace-icon fa fa-key"></i> <span
															class="bigger-110">Thêm nội dung</span>
													</button>
												</div>
