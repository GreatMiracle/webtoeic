							...
							<div id="login-box"
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<p  style="color:red"><%=request.getAttribute("msgregister")!=null?request.getAttribute("msgregister"):" "%></p>

										<form action="LoginController" method="POST">
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" class="form-control" placeholder="Username" name="membername"/>
														<i class="ace-icon fa fa-user"></i>
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="password" class="form-control"
														placeholder="Password" name="memberpass"/> <i class="ace-icon fa fa-lock"></i>
												</span>
												</label>
							...
							<div id="signup-box" class="signup-box widget-box no-border">
								<div class="widget-body">
									<div class="widget-main">
										...
										<form name="registerForm" action="RegisterController" method="POST" onsubmit="return validation()">
											<fieldset>
											
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" class="form-control" placeholder="Full Name" name="name" />
													...
													class="block input-icon input-icon-right"> <input
														type="password" class="form-control" 
														placeholder="Password" id="pwd" name="memberpass"/> <i class="ace-icon fa fa-lock"></i>
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="password" class="form-control" 
														placeholder="Repeat password" id="confpass"/> <i
												...
												<div class="clearfix">
													...
													<button id="submitReg" type="submit" 
...
<![endif]-->
	...
	<script type="text/javascript">
		window.jQuery
				|| document.write("<script src='Template/Backend/assets/js/jquery.min.js'>"
						+ "<"+"/script>");
	</script>
...
<![endif]-->
	...
	<script type="text/javascript">
		function validation()
		{
			...
			var membername = document.registerForm.membername.value;
			if(name=="")
			{
				...
				document.registerForm.membername.focus();
				return false;
			}
		...
		jQuery(function($) {
			...
			$(document).ready(function() {
			    $('#submitReg').click(function(event){
			        ...
			        if(len < 6) {
			            alert("Password of length than 6 letter");
			            // Prevent form submission
			            event.preventDefault();
			        }
			         
			        if($('#pwd').val() != $('#confpass').val()) {
