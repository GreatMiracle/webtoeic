...
<head>
<meta charset="UTF-8">
<title>Thêm audio và hình ảnh từ vựng</title>
								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter bigger">
											<i class="ace-icon fa fa-coffee green"></i> Thêm audio và hình ảnh từ vựng
										</h4>
										...
										<form action="Themaudiohinhanhtuvung" method="POST" enctype="multipart/form-data">
												<fieldset>
													<label class="block clearfix">
														<c:if test="${msgthemaudiohinhanhtuvung != null}">
															${msgthemaudiohinhanhtuvung}
														</c:if>
													</label>
