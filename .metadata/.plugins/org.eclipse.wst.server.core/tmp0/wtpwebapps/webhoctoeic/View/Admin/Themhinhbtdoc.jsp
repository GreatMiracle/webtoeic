								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter bigger">
											<i class="ace-icon fa fa-coffee green"></i> Thêm hình bài tập đọc
										</h4>

										<div class="space-6"></div>

										<form
											action="Themhinhbtdoc?readexeriseid=${readexeriseid}"
											method="POST" enctype="multipart/form-data">
											<fieldset>
												<label class="block clearfix"> <%=request.getAttribute("msgquanlydsbtdoc") != null
					? request.getAttribute("msgquanlydsbtdoc")
					: " "%>
												...
												<div class="clearfix">
													...
													<button type="submit"
														...
														<i class="ace-icon fa fa-key"></i> <span
															class="bigger-110">Thêm hình bài tập đọc</span>
													</button>
												</div>
