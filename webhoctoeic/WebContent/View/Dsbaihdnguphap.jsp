...
<body>
	...
	<div class="container" id="searchresult">
		...
		<div class="container">
			...
			<!-- /. PAGE TITLE-->
			<div class="row">
				<c:forEach var="listGmgl" items="${listGmgl}">
					<div class="span6">
						<div class="media">
							...
							<div class="media-body">
								...
								<a
									href="Chitietbaihdnguphapforward?mabaihdnguphap=${listGmgl.grammarguidelineid}"
									class="btn">Xem bài hướng dẫn</a>
							</div>
						</div>
					</div>
				</c:forEach>
			...
			<div class="pagination">
				<ul>
					<c:if test="${numberpage == 1}">
						...
						<li><a href="Dsbaihdnguphapforward?pageid=${numberpage}">${numberpage}</a></li>
						<li><a href="Dsbaihdnguphapforward?pageid=${numberpage+1}">${numberpage+1}</a></li>
						<li><a href="Dsbaihdnguphapforward?pageid=${numberpage+1}">Next
								&raquo;</a></li>
					</c:if>
					<c:if test="${numberpage == maxpageid}">
						<li><a href="Dsbaihdnguphapforward?pageid=${numberpage-1}">&laquo;Prev</a></li>
						<li><a href="Dsbaihdnguphapforward?pageid=${numberpage-1}">${numberpage-1}</a></li>
						<li><a href="Dsbaihdnguphapforward?pageid=${numberpage}">${numberpage}</a></li>
