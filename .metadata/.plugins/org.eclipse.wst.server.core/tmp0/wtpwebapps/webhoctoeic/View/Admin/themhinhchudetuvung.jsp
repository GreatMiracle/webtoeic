								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter bigger">
											<i class="ace-icon fa fa-coffee green"></i> Thêm ảnh chủ đề từ vựng
										</h4>

										<div class="space-6"></div>

										<form
											action="Themhinhchudetuvung?vocabularyguidelineid=<%=request.getAttribute("vocabularyguidelineid")%>"
											method="POST" enctype="multipart/form-data">
											<fieldset>
												<label class="block clearfix"> <%=request.getAttribute("msgdstuvung") != null
					? request.getAttribute("msgdstuvung")
					: " "%>
												...
												<div class="clearfix">
													...
													<button type="submit"
														...
														<i class="ace-icon fa fa-key"></i> <span
															class="bigger-110">Thêm ảnh chủ đề</span>
													</button>
												</div>
