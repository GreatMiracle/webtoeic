							...
							<div class="row">
								...
								<div class="col-sm-offset-1 col-sm-10">
									...
									<h4 class="pink">
										...
										<a class="red" data-toggle="modal"><%=request.getAttribute("msggrammarguidelinecontent") != null
					? request.getAttribute("msggrammarguidelinecontent")
					: " "%></a>
									</h4>
									...
									<div class="widget-box widget-color-blue">
										...
										<div class="widget-body">
											<form
												action="Grammarguidelinecontentcontroller?grammarguidelineid=<%=request.getAttribute("grammarguidelineid")%>"
												method="POST">
												<div>
												

													<textarea name="content" data-provide="markdown"
														data-iconlibrary="fa" rows="18" data-hidden-buttons="Image">
<%-- 															<%=request.getAttribute("contentStr") != null ? request.getAttribute("contentStr") : " " %> --%>
												...
												<div class="widget-toolbox padding-4 clearfix">
													...
													<div class="btn-group pull-right">
														<button class="btn btn-sm btn-purple">
															<i class="ace-icon fa fa-floppy-o bigger-125"></i> Thêm
															nội dung
														</button>
													</div>
												</div>
