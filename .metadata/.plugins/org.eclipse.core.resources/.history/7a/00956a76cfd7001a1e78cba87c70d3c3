								...
								<div class="col-xs-12">
									<table id="simple-table"
										...
										<tbody>
											...
											<c:forEach items="${lsAllDethi}" var="list">
												<tr>
													<td class="center">${list.examinationid}</td>
													<td class="center">${list.examinationame}</td>
													<td class="center">${list.examinatioimage}</td>
<!-- 													<td class="center"> -->
<%-- 														<img src="Imageupload/${list.examinatioimage}" class="media-object" alt=''  width="64px" height="40px"/> --%>
<!-- 													</td> -->
													...
													<td class="center"><a class="green"
														href="Themcauhoidethi?examinationid=${list.examinationid}">
									...
									<div>
										<ul class="pagination">
											<c:if test="${numberpage == 1}">
												...
												<li  class="active"><a href="Hienthidsquanlydethi?pageid=${numberpage}">${numberpage}</a></li>
												<c:if test="${numberpage == 1 && numberpage < maxpageid}">
													<li><a href="Hienthidsquanlydethi?pageid=${numberpage+1}">${numberpage+1}</a></li>
											...
											<c:if test="${numberpage > 1 && numberpage < maxpageid}">
												<li><a href="Hienthidsquanlydethi?pageid=${numberpage-1}">Prev</a></li>
												<li><a href="Hienthidsquanlydethi?pageid=${numberpage-1}">${numberpage-1}</a></li>
												<li class="active"><a class="active" href="Hienthidsquanlydethi?pageid=${numberpage}">${numberpage}</a></li>
												<li><a href="Hienthidsquanlydethi?pageid=${numberpage+1}">${numberpage+1}</a></li>
												<li><a href="Hienthidsquanlydethi?pageid=${numberpage+1}">Next</a></li>
											</c:if>
										</ul>
							...
							<div class="row">
								<div class="col-xs-12">
									<button type="button"
										...
										data-target="#myModal">Thêm đề thi</button>
				...
				<div class="modal-content">
								...
								<div class="col-sm-9">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"
											for="form-field-1">Nhập tên đề thi</label>
					...
					<div class="modal-footer">
						<button class="btn btn-info" type="submit">
							<i class="ace-icon fa fa-check bigger-110"></i> Thêm tên đề thi
						</button>
					</div>
				</div>
			</form>
