...
<head>
<meta charset="UTF-8">
<title>Thêm hình bài nghe</title>
								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter bigger">
											<i class="ace-icon fa fa-coffee green"></i> Thêm hình bài nghe
										</h4>

										<div class="space-6"></div>

										<form
											action="Themhinhbtnghe?listenexerciseid=${listenexerciseid}"
											method="POST" enctype="multipart/form-data">
											<fieldset>
												<label class="block clearfix"> <%=request.getAttribute("msgquanlydsbtnghe") != null
												...
												<div class="clearfix">
													...
													<button type="submit"
														...
														<i class="ace-icon fa fa-key"></i> <span
															class="bigger-110">Thêm hình bài nghe</span>
													</button>
												</div>
